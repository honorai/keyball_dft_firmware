...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LCTL  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                                        KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_BSLS  ,
              KC_LALT,KC_LGUI,KC_LCTL     ,LT(1,KC_SPC),LT(2,KC_DEL),                             KC_BSPC,LT(4,KC_ENT), _______  ,   _______  , TD_LANGSWITCH
  ),
//num
  [1] = LAYOUT_universal(
    KC_ESC ,  KC_F1   , KC_F2    , KC_F3   , KC_F4    , KC_F5    ,                                         KC_F6    , KC_F7    , KC_F8    , KC_F9    , KC_F10   , _______   ,
    KC_LSFT ,  KC_1    , KC_2     , KC_3    , KC_4     , KC_5     ,                                   KC_6  , TD_7_UNDERSCORE  , KC_8    , KC_9  , KC_0  , _______   ,
...
//mouse
  [4] = LAYOUT_universal(
    ...
    RGB_RMOD , _______  , _______  , CPI_D100  , CPI_D1K  , SCRL_DVD ,                                        _______  , _______ , TD_CLOSE_ALLCLOSE , _______  , _______  , _______ ,
